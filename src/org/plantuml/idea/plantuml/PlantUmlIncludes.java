    ...
    public static Map<File, Long> commitIncludes(String source, @Nullable File baseDir) {
        try {
            if (baseDir != null) {
                ...
                BlockUmlBuilder blockUmlBuilder = new BlockUmlBuilder(Collections.<String>emptyList(), PlantUmlSettings.getInstance().getEncoding(), Defines.createEmpty(), new StringReader(source), new SFile(baseDir.getAbsolutePath()), null);
